 ...
 */
function _civicrm_api3_membershipperiod_create_spec(&$spec) {
 ...
 */
function civicrm_api3_membershipperiod_create($params) {
 ...
 * @throws API_Exception
 */
function civicrm_api3_membershipperiod_delete($params) {
